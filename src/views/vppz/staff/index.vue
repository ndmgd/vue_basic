...
import { photoList, companion, companionList, deleteCompanion } from '@/apis'
...
const handleSelectionChange = (val: any) => {
  // 只返回id，不需要其他数据
  multipleSelection.value = val.map((item: any) => ({ id: item.id }))
  console.log('当前选中项ID', multipleSelection)
}
...
const confirmEvent = () => {
  ...
  console.log('删除项', multipleSelection.value)
